...
//                if(!notesRepo.existsBynoteTitle(notesVo.getTitle())) {
                    Notes notesV0 = convertEntityToVO(notesVo, multipartFile);
                    notesRepo.save(notesV0);
//                }else {
//                    notesVo.setStatus("Title is already exists");
//                    System.out.println("This title is already exists");
//                }
    ...
    private List<AttachmentVo> EntityToVoAttachment(Notes notes){
        ...
        notes.getAttachments().forEach(attachment -> {
            ...
            attachmentVo.setFileUrl(getURl(attachment.getFileName()));
    ...
    private List<ActionItemVO> EntityToVoActionItem(Notes notes){
        ...
        notes.getActionItems().forEach(actionItem -> {
...
//            String changeFile = System.currentTimeMillis()+" - "+multipartFile.getOriginalFilename();
    ...
    private Notes convertEntityToVO(NotesVo notesVo,List<MultipartFile> file){
